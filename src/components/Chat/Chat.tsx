    ...
    <div className='react-chatbot-kit-chat-container'>
      <div className='react-chatbot-kit-chat-inner-container'>
        ...
        <div className='react-chatbot-kit-chat-input-container'>
          <div
            className={state?.disableInput ? 'react-chatbot-kit-chat-input-form react-chatbot-kit-chat-input-form-disable' : 'react-chatbot-kit-chat-input-form'}
          >
            <textarea
              onKeyPress={(event) => {
            ...
            >
              <ChatIcon
                className={state?.disableInput || input === "" ? 'react-chatbot-kit-chat-btn-send-icon react-chatbot-kit-chat-btn-send-icon-disable' : 'react-chatbot-kit-chat-btn-send-icon'}/>
            </button>
          </div>
        </div>
      </div>
